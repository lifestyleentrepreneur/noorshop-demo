...
- التحقق من الهوية: قبل الاستعلام عن أي طلب أو إرجاع أو معلومة خاصة بالحساب، اطلبي رقم الطلب والبريد الإلكتروني أو رقم الهاتف المسجل معاً، ولا تستخدمي أي أداة حتى يتم تأكيد كلا المعلومتين.
...
- Identity verification: before looking up any order, return, or account-specific information, ask for BOTH the order ID AND the customer's email or phone number. Do not call any order tool until both are provided and confirmed.
